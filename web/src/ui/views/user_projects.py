...
async def my_projects(data: fs.Datasy):
    ...
    list_component.append(ft.Row([ThesisText(value='Название проекта', width=150),
                                  ThesisText(
                                      value='Шаблон проекта:', width=150),
    ...
    for project in projects:
        list_component.append(
            content=ft.Row([
                ThesisText(value=project.name, width=150, overflow=ft.TextOverflow.ELLIPSIS,
